            ...
            <section className="skills-section" id='skills'>
                ...
                <div className="skills-grid">
                    <div className="skill-card">
                        ...
                        <div className="skill-overlay">{t("skills.sixYears")}</div>
                    </div>
                    <div className="skill-card">
                        <i className="fa-brands fa-react skill-icon"></i>
                        <p className="skill-name">React</p>
                        <p className="skill-subtitle">{t("skills.framework")}</p>
                        <div className="skill-overlay">{t("skills.threeYears")}</div>
                    </div>
                    <div className="skill-card">
                        ...
                        <div className="skill-overlay">{t("skills.fourYears")}</div>
                    </div>
                    <div className="skill-card">
                    ...
                    <div className="skill-card">
                        ...
                        <div className="skill-overlay">{t("skills.fiveYears")}</div>
                    </div>
                    <div className="skill-card">
